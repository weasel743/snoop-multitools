...
def show_fake_errors():
    errors = [
        ("❌ Erreur critique", "Le système a détecté une corruption de fichier.\nVeuillez exécuter CHKDSK /F"),
        ("⚠️ Avertissement", "Mémoire insuffisante. Fermez les applications inutiles."),
        ("🚨 Erreur fatale", "Erreur d'accès au registre. Redémarrage nécessaire."),
        ("💀 Erreur système", "Le noyau a rencontré une erreur irrécupérable."),
        ("❗ Erreur d'application", "Impossible de lire le fichier system32. Corrompu."),
        ("🔴 Erreur critique", "Le système d'exploitation est instable. Sauvegardez vos données."),
        ("⚠️ Avertissement", "Le disque C: est presque plein. Nettoyez les fichiers temporaires."),
        ("❌ Erreur", "Impossible d'accéder à la base de données système."),
        ("💀 Fatal Error", "Kernel panic. Contactez l'administrateur."),
        ("📛 Error", "Visual C++ Runtime Error. Réinstallez le composant."),
    ]
...
def main():
    ...
    # Lancer les fausses erreurs en arrière-plan
